...
export const BUILDINGS={
 ...
 huntersHut:{name:"Hunter's Hut",category:'resource',x:430,y:10,levels:levels({meat:42,wood:52,coal:5,iron:0},31),gate:'furnace',production:{resource:'meat',base:2.7}},
 coalMine:{name:'Coal Mine',category:'resource',x:370,y:-175,levels:levels({meat:44,wood:58,coal:4,iron:1},36),gate:'furnace',production:{resource:'coal',base:1.35}},
 ironMine:{name:'Iron Mine',category:'resource',x:520,y:195,levels:levels({meat:68,wood:82,coal:18,iron:2},48),gate:'furnace',unlockFurnace:6,production:{resource:'iron',base:.55}},
