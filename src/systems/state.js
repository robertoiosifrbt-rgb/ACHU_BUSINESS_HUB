...
export function defaultState(){return{
 ...
 research:{},construction:null,researchJob:null,power:520,lastSavedAt:Date.now(),collectReady:{},claimedChapters:{}
}}
function migrate(raw){
 ...
 return{...base,...raw,resources,buildings,collectReady:{...base.collectReady,...raw.collectReady},claimedChapters:{...base.claimedChapters,...raw.claimedChapters},lastSavedAt:raw.lastSavedAt??Date.now()}
}
